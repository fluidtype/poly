      ...
      >
        ...
        >
          ...
          <input
            ...
            className="min-w-0 flex-1 bg-transparent text-sm text-[var(--fg)] placeholder:text-[var(--muted)] focus-visible:outline-none"
            type="search"
          />
          <Button
            type="submit"
            size="sm"
            variant="secondary"
            className="rounded-full px-4 text-xs font-semibold text-[var(--fg)]"
          >
            Run query
          </Button>
        </form>
